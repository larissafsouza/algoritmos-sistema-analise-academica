...
public class AnaliseDeJubilado {
	...
	public AnaliseDeJubilado(String curso){
		current_curso = curso;
			alunos = null;
				try {
...
//		ativ.getAverageDisciplines("jubilado (crit. 02)");
		...
		// SELECIONADAS DENTRO DO CONJUNTO DE DISCIPLINAS FEITAS PELOS ALUNOS DENTRO DO CONJUNTO
//		ativ.getAverageDisciplinesGeral("jubilado (crit. 02)");
